...
describe("a state with a clipped path", () => {
    ...
    beforeEach(() => {
        ...
        currentPath = InstructionsWithPath.create(defaultState, {getInfinity: () => undefined, getPathInstructionToGoAroundViewbox: () => undefined});
    ...
    describe("that is saved and to which a clipped path is added", () => {
        ...
        beforeEach(()=> {
            currentState = currentState.saved();
            addedClippedPath = InstructionsWithPath.create(currentState, {getInfinity: () => undefined, getPathInstructionToGoAroundViewbox: () => undefined});
        ...
        describe("and that is then restored, saved again and to which another clipped path is added", () => {
            ...
            beforeEach(() => {
                ...
                currentState = currentState.saved();
                const differentAddedClippedPath: InstructionsWithPath = InstructionsWithPath.create(currentState, {getInfinity: () => undefined, getPathInstructionToGoAroundViewbox: () => undefined});
