...
describe("a clipped paths", () => {
    ...
    describe("and another one", () => {
        ...
        beforeEach(() => {
            ...
            clippedPath = InstructionsWithPath.create(currentState, {getInfinity: () => undefined, getPathInstructionToGoAroundViewbox: () => undefined});
        ...
        describe("containing one more clipped path", () => {
            ...
            describe("and another one", () => {
                ...
                beforeEach(() => {
                    currentState = clippedPath.state;
                    const otherClippedPath: InstructionsWithPath = InstructionsWithPath.create(currentState, {getInfinity: () => undefined, getPathInstructionToGoAroundViewbox: () => undefined});
